...
namespace Mortician.Core
{
    ...
    /// </summary>
    /// <seealso cref="System.IEquatable{Mortician.Core.ManagedCodeLocation}" />
    /// <seealso cref="System.IComparable{Mortician.Core.ManagedCodeLocation}" />
    /// <seealso cref="Mortician.Core.CodeLocation" />
