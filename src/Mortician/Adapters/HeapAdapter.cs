...
using ClrRootStackwalkPolicy = Mortician.Core.ClrMdAbstractions.ClrRootStackwalkPolicy;
...
namespace Mortician.Adapters
{
    ...
    ///     Class HeapAdapter.
    /// </summary>
    /// <seealso cref="Mortician.Core.ClrMdAbstractions.IClrHeap" />
    internal class HeapAdapter : BaseAdapter, IClrHeap
    {
        ...
        ///     <see cref="T:Mortician.Core.ClrMdAbstractions.ClrRootStackwalkPolicy" />
        /// </summary>
